 ...
 */
const valorSaldoElement: HTMLElement = document.querySelector(".block-saldo .saldo-valor .valor");
const dataAcessoElement: HTMLElement = document.querySelector(".block-saldo time");
